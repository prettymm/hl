...
var s_account = "";
var pageURLContents = window.location.pathname.substring(0).split('/'),
localeName = pageURLContents[1],
externalLinkTrackVar =false;

if(localeName.trim().length > 4)
{
	localeName = localeName.trim().substr(0,2).toLowerCase() + '_' + localeName.trim().substr(3,2).toUpperCase(); 
}
if ((window.location.toString().toLowerCase().indexOf('dev.') >= 0 || window.location.toString().toLowerCase().indexOf('staging.') >= 0 || window.location.toString().toLowerCase().indexOf('dev-') >= 0 || window.location.toString().toLowerCase().indexOf('staging-') >= 0)) {
    localeName = 'de_v1';
}

switch (localeName.trim()) {
    case "en_EU":
    case "en_EE":
    case "en_HR":
    case "en_CY":
    ...
    case "en_MT":
    case "en_IL":
        s_account = "hdothereurope,hdglobal3";
        break;
    case "en_AA":
        s_account = "hdafrica,hdglobal3";
        break;
    case "en_GB":
        s_account = "hdunitedkingdom,hdglobal3";
        break;
    case "en_IE":
        s_account = "hdireland,hdglobal3";
        break;
    case "en_ZZ":
        s_account = "hdmiddleeast,hdglobal3";
        break;
    case "tr_TR":
        s_account = "hdturkey,hdglobal3";
        break;
    case "el_GR":
        s_account = "hdhdgreecehdgreece,hdglobal3";
        break;
    case "de_DE":
        s_account = "hdgermany,hdglobal3";
        break;
    case "de_AT":
        s_account = "hdaustria,hdglobal3";
        break;
    case "de_CH":
        s_account = "hdchgerman,hdglobal3";
        break;
    case "it_IT":
        s_account = "hditaly,hdglobal3";
        break;
    case "it_CH":
        s_account = "hdchitalian,hdglobal3";
        break;
    case "fr_FR":
        s_account = "hdfrance,hdglobal3";
        break;
    case "fr_BE":
        s_account = "hdbefrench,hdglobal3";
        break;
    case "fr_LU":
        s_account = "hdluxembourg,hdglobal3";
        break;
    case "es_ES":
        s_account = "hdspain,hdglobal3";
        break;
    case "pt_PT":
        s_account = "hdportugal,hdglobal3";
        break;
    case "da_DK":
    case "dk_DK":
        s_account = "hddenmark,hdglobal3";
        break;
    case "sw_SE":
    case "sv_SE":
        s_account = "hdsweden,hdglobal3";
        break;
    case "no_NO":
        s_account = "hdnorway,hdglobal3";
        break;
    case "fi_FI":
        s_account = "hdfinland,hdglobal3";
        break;
    case "ru_RU":
        s_account = "hdrussia,hdglobal3";
        externalLinkTrackVar = false;
        break;
    case "cs_CZ":
        s_account = "hdczechrepublic,hdglobal3";
        break;
    case "nl_NL":
        s_account = "hdnetherlands,hdglobal3";
        break;
    case "fr_CH":
        s_account = "hdchfrench,hdglobal3";
        break;
    case "nl_BE":
        s_account = "hdbedutch,hdglobal3";
        break;
    case "es_XX":
        s_account = "hdhdlatinamerica,hdglobal3";
        break;
    case "pl_PL":
        s_account = "hdpoland,hdglobal3";
        break;
    case "ar_ZZ":
        s_account = "hdhdmiddleeast,hdglobal3";
        break;
    case "hu_HU":
        s_account = "hdhungary,hdglobal3";
        break;
    case "es_MX":
        s_account = "hdmexico,hdglobal3";
        break;
    case "en_US":
        s_account = "hdunitedstates,hdglobal3";
        break;
    case "en_AU":
        s_account = "hdaustralia,hdglobal3";
		externalLinkTrackVar = false;
        break;
    case "pt_BR":
        s_account = "hdbrazil,hdglobal3";
        break;
    case "en_AP":
        s_account = "hdotherap,hdglobal3";
        break;
    case "en_CA":
        s_account = "hdcanada,hdglobal3";
        break;
    case "fr_CA":
        s_account = "hdcafrench,hdglobal3";
        break;
    case "zh_CN":
        ...
        break;
    case "en_GU":
        s_account = "hdguam,hdglobal3";
        break;
    case "en_IN":
        s_account = "hdindia,hdglobal3";
		externalLinkTrackVar = false;
        break;
    case "ja_JP":
        ...
        break;
    case "es_PR":
        s_account = "hdpuertorico,hdglobal3";
        break;
    case "zh_TW":
        s_account = "hdtaiwan,hdglobal3";
        break;
    case "vi_VN":
        s_account = "hdvietnam,hdglobal3";
        break;
    case "th_TH":
        s_account = "hdthailand,hdglobal3";
        break;
	case "id_ID":
		s_account = "hdhdindonesia,hdglobal3";
		externalLinkTrackVar = false;
		break;
    default:
        s_account = "hdglobal3";
...
s.trackExternalLinks = externalLinkTrackVar
...
function s_doPlugins(s) {
    ...
    if (s.prop53 && (s.linkTrackVars.indexOf("prop53") > -1)) {
    ...
    //Login State
    if (document.cookie.match("LtpaToken2=")) {
        s.prop24 = "HardLoggedIn";
    } else if (document.cookie.match("WC_PROFILEUSER_NICKNAME=")) {
        s.prop24 = "SoftLoggedIn";
    } else if (document.cookie.match("WC_PERSISTENT=")) {} else {}
    s.eVar24 = s.prop24;
...
s.setupLinkTrack = new Function("vl", "c", "" + "var s=this;var l=s.d.links,cv,cva,vla,h,i,l,t,b,o,y,n,oc,d='';cv=s." + "c_r(c);if(vl&&cv!=''){cva=s.split(cv,'^^');vla=s.split(vl,',');for(" + "x in vla)s._hbxm(vla[x])?s[vla[x]]=cva[x]:'';}s.c_w(c,'',0);if(!s.e" + "o&&!s.lnk)return '';o=s.eo?s.eo:s.lnk;y=s.ot(o);n=s.oid(o);if(s.eo&" + "&o==s.eo){while(o&&!n&&y!='BODY'){o=o.parentElement?o.parentElement" + ":o.parentNode;if(!o)return '';y=s.ot(o);n=s.oid(o);}for(i=0;i<4;i++" + ")if(o.tagName)if(o.tagName.toLowerCase()!='a')if(o.tagName.toLowerC" + "ase()!='area')o=o.parentElement;}b=s._LN(o);o.lid=b[0];o.lpos=b[1];" + "if(s.hbx_lt&&s.hbx_lt!='manual'){if((o.tagName&&s._TL(o.tagName)=='" + "area')){if(!s._IL(o.lid)){if(o.parentNode){if(o.parentNode.name)o.l" + "id=o.parentNode.name;else o.lid=o.parentNode.id}}if(!s._IL(o.lpos))" + "o.lpos=o.coords}else{if(s._IL(o.lid)<1)o.lid=s._LS(o.lid=o.text?o.t" + "ext:o.innerText?o.innerText:'');if(!s._IL(o.lid)||s._II(s._TL(o.lid" + "),'<img')>-1){h=''+o.innerHTML;bu=s._TL(h);i=s._II(bu,'<img');if(bu" + "&&i>-1){eval(\"__f=/ src\s*=\s*[\'\\\"]?([^\'\\\" ]+)[\'\\\"]?/i\")" + ";__f.exec(h);if(RegExp.$1)h=RegExp.$1}o.lid=h}}}h=o.href?o.href:'';" + "i=h.indexOf('?');h=s.linkLeaveQueryString||i<0?h:h.substring(0,i);l" + "=s.linkName?s.linkName:s._hbxln(h);t=s.linkType?s.linkType.toLowerC" + "ase():s.lt(h);oc=o.onclick?''+o.onclick:'';cv=s.pageName+'^^'+o.lid" + "+'^^'+s.pageName+' | '+(o.lid=o.lid?o.lid:'no &lid')+'^^'+o.lpos;if" + "(t&&(h||l)){cva=s.split(cv,'^^');vla=s.split(vl,',');for(x in vla)s" + "._hbxm(vla[x])?s[vla[x]]=cva[x]:'';}else if(!t&&oc.indexOf('.tl(')<" + "0){s.c_w(c,cv,0);}else return ''");
*/
...
s._LS = new Function("a", "" + "var s=this,b,c=100,d,e,f,g;b=(s._IL(a)>c)?escape(s._IS(a,0,c)):esca" + "pe(a);b=s._LSP(b,'%0A','%20');b=s._LSP(b,'%0D','%20');b=s._LSP(b,'%" + "09','%20');c=s._IP(b,'%20');d=s._NA();e=0;for(f=0;f<s._IL(c);f++){g" + "=s._RP(c[f],'%20','');if(s._IL(g)>0){d[e++]=g}}b=d.join('%20');retu" + "rn unescape(b)");
